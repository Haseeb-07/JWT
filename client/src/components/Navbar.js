...
const Navbar = () => {
    ...
    return (
        <nav className="bg-gray-800 rounded-[32.5px]">
                    ...
                    <div className="flex-1 flex items-center justify-end sm:items-stretch sm:justify-end">
                        <div className="hidden sm:block">
                            <div className="flex space-x-4">
                                ...
                                <Link to="/foodjoke" className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Services</Link>
                                <Link to="/foodjoke" className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Get Food joke</Link>
                            </div>
                        </div>
                    </div>
                </div>
